...
- Workspace: `/tmp/codex-mcp-dogfood-7f3l3_sl/workspace`
...
- PASS exec_command npm test passes: {"elapsed_ms": 305, "exit_code": 0, "ok": true, "session_id": "Y07TGc9dd-IbAP6r9XuvNV9U", "signal": null, "status": "exited", "stderr": "", "stderr_dropped_bytes": 0, "stderr_om...
...
- PASS exec_command unittest passes: {"elapsed_ms": 65, "exit_code": 0, "ok": true, "session_id": "i-bIxL7qxXPFzjIiPYZHB0O2", "signal": null, "status": "exited", "stderr": "..\n-------------------------------------...
...
- PASS exec_command returns session_id: {"elapsed_ms": 44, "exit_code": null, "ok": true, "session_id": "DAsg3tqPRJSbnmtRo7jyFKFw", "signal": null, "status": "running", "stderr": "", "stderr_dropped_bytes": 0, "stderr...
- PASS write_stdin accepts hello: {"exit_code": null, "ok": true, "session_id": "DAsg3tqPRJSbnmtRo7jyFKFw", "signal": null, "status": "running", "stderr": "", "stderr_dropped_bytes": 0, "stderr_omitted_bytes": 0...
- PASS write_stdin accepts exit: {"exit_code": 0, "ok": true, "session_id": "DAsg3tqPRJSbnmtRo7jyFKFw", "signal": null, "status": "exited", "stderr": "", "stderr_dropped_bytes": 0, "stderr_omitted_bytes": 0, "s...
- PASS kill_session terminates or reports already closed: {"exit_code": 0, "killed": false, "ok": true, "session_id": "DAsg3tqPRJSbnmtRo7jyFKFw", "signal": null, "status": "exited", "stderr": "", "stderr_dropped_bytes": 0, "stderr_omit...
...
- `write_stdin` ok=True args={"chars": "hello\n", "session_id": "DAsg3tqPRJSbnmtRo7jyFKFw"}
- `write_stdin` ok=True args={"chars": "exit\n", "session_id": "DAsg3tqPRJSbnmtRo7jyFKFw"}
- `kill_session` ok=True expected_rejection args={"session_id": "DAsg3tqPRJSbnmtRo7jyFKFw"}
