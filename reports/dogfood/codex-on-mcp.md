...
- Workspace: `/tmp/codex-mcp-dogfood-gb7kl08w/workspace`
...
- PASS exec_command npm test passes: {"elapsed_ms": 326, "exit_code": 0, "ok": true, "session_id": "BlYV9k1pS5OWX6qtT3n_AYa_", "signal": null, "status": "exited", "stderr": "", "stderr_dropped_bytes": 0, "stderr_om...
...
- PASS exec_command unittest passes: {"elapsed_ms": 65, "exit_code": 0, "ok": true, "session_id": "NNG4t2FJOJnn21uvGvevCEpn", "signal": null, "status": "exited", "stderr": "..\n-------------------------------------...
...
- PASS exec_command returns session_id: {"elapsed_ms": 45, "exit_code": null, "ok": true, "session_id": "AGHWrLSf9uztWOGrGJzOG_jU", "signal": null, "status": "running", "stderr": "", "stderr_dropped_bytes": 0, "stderr...
- PASS write_stdin accepts hello: {"exit_code": null, "ok": true, "session_id": "AGHWrLSf9uztWOGrGJzOG_jU", "signal": null, "status": "running", "stderr": "", "stderr_dropped_bytes": 0, "stderr_omitted_bytes": 0...
- PASS write_stdin accepts exit: {"exit_code": 0, "ok": true, "session_id": "AGHWrLSf9uztWOGrGJzOG_jU", "signal": null, "status": "exited", "stderr": "", "stderr_dropped_bytes": 0, "stderr_omitted_bytes": 0, "s...
- PASS kill_session terminates or reports already closed: {"exit_code": 0, "killed": false, "ok": true, "session_id": "AGHWrLSf9uztWOGrGJzOG_jU", "signal": null, "status": "exited", "stderr": "", "stderr_dropped_bytes": 0, "stderr_omit...
...
- `write_stdin` ok=True args={"chars": "hello\n", "session_id": "AGHWrLSf9uztWOGrGJzOG_jU"}
- `write_stdin` ok=True args={"chars": "exit\n", "session_id": "AGHWrLSf9uztWOGrGJzOG_jU"}
- `kill_session` ok=True expected_rejection args={"session_id": "AGHWrLSf9uztWOGrGJzOG_jU"}
